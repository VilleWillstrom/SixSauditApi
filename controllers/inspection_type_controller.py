...
async def post_inspection_type(req: InspectionTypeCreateReq, service: InspectionTypeServ):
    ...
    # Add the inspection type using the service
...
async def update_inspection_type_by_id(inspection_type_id: int, req: InspectionTypeCreateReq, service: InspectionTypeServ):
    inspection_type = models.Inspectiontype(
        id=inspection_type_id,
        name=req.name
    )
    # Update the inspection type using the service
...
async def delete_inspection_type_by_id(inspection_type_id: int, service: InspectionTypeServ):
    # Delete the inspection type using the service
